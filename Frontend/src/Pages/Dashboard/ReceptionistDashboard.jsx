...
const ReceptionistDashboard = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:5000/api/receptionist/dashboard", {
      ...
      .then((data) => {
        setStats(
          data.data || { totalPatientsToday: 0, pendingAppointments: 0 }
        );
      })
  ...
  const showCancelConfirmation = (appointmentId) => {
    ...
    toast.info(
      ({ closeToast }) => (
        <div style={{ minWidth: "420px", padding: "15px" }}>
          <p
          ...
          <div className="d-flex justify-content-end gap-2">
            <button
              ...
              style={{ minWidth: "85px", height: "40px", fontWeight: "600" }}
              onClick={closeToast}
            >
              No
            </button>
      ...
      <div className="container-fluid p-0">
        <div className="row g-0">
          ...
          <div className="col-md-2 sidebar vh-100 p-3">
            <h5 className="text-center mb-4 fw-bold">Receptionist Panel</h5>

            <ul className="list-group list-group-flush">
              <li className="list-group-item fw-bold">Dashboard</li>
          ...
          <div className="col-md-10 p-4">
            <h2 className="text-center mb-4 fw-bold">RECEPTIONIST DASHBOARD</h2>
            ...
            <div className="row g-4 mb-4">
              ...
              <div className="col-md-6">
                <div className="stats-card" style={{ backgroundColor: "#ef4444" }}>
            ...
            <div className="card footer-card shadow">
              <div className="card-body text-center">
                ...
                <p className="mb-0">Receptionist Control Panel</p>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <div className="row g-4">
                      ...
                      {[
                        { label: "Patient ID",    value: displayValue(selectedPatient.patientId) },
                        { label: "Full Name",     value: displayValue(selectedPatient.name) },
                        {
                          label: "Date of Birth",
                        ...
                        { label: "Gender",        value: displayValue(selectedPatient.gender) },
                        { label: "Phone Number",  value: displayValue(selectedPatient.phone) },
                        { label: "Blood Group",   value: displayValue(selectedPatient.bloodGroup) },
                        { label: "Current Status",value: displayValue(selectedPatient.status) },
                        { label: "Address",       value: displayValue(selectedPatient.address) },
                      ].map(({ label, value }) => (
